...
class Config:
    ...
    max_usernames_to_check: int = 1000
    min_score: int = 81
    min_project_strength: float = 0.0
...
def load_config() -> Config:
    return Config(
        ...
        max_usernames_to_check=_int_env("MAX_USERNAMES_TO_CHECK", 1000),
        min_score=_int_env("MIN_SCORE", 81),
        min_project_strength=float(os.getenv("MIN_PROJECT_STRENGTH", "0.0")),
