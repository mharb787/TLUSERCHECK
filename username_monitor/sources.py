...
class SourceClient:
    ...
    def collect_projects(self, pagination_state: PaginationState) -> List[Project]:
        ...
        all_projects.extend(self._wordle_list())
    ...
    def _wordle_list(self) -> List[Project]:
        ...
        return [Project(name=word, symbol="", source="Wordle List", raw_strength=10.0) for word in words]
